...
class MainActivity : AppCompatActivity() {
    ...
    private  lateinit var BookingTestContainer : CardView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BookingTestContainer = findViewById(R.id.TestBookingContainer)
        ...
        BookingTestContainer.setOnClickListener(){
            // Navigate to practice test activity
            val BookingTestIntent = Intent(this, MapsActivity::class.java)
            startActivity(BookingTestIntent)
            finish()
        }
